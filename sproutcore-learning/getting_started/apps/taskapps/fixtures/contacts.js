sc_require('models/contacts');

Taskapps.contacts.FIXTURES = [
	{ 
			guid : 0,
			name : "Abdul Kalaam",
	...
	,{
			guid : 3,
			name : "Bhagat Sign",
			desc : "Freedom Fighter",
			pic	 : "http://inspiringquotes.in/wp-content/uploads/2013/04/Bhagat-Singh-Suvichar-Wallpaper.jpg"
	},{ 
			guid : 4,
			name : "Gandhiji",
			desc : "Mahatma - Father of Nation",
